...
SECRET_KEY = 'django-insecure-t62sdn*%8&ge5t-)2%z^vf3$y76zo6ghg07c(ab&)9)m_q#ig!'
...
MIDDLEWARE = [
    ...
    'mealmanager.middleware.LoginRequiredMiddleware',
]
...
MEDIA_URL ='/media/'
MEDIA_ROOT = Path(BASE_DIR, 'mealmanager/media')
